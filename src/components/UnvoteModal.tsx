...
interface UnvoteModalProps {
  projectTitle: string
  onConfirm: () => void
  onCancel: () => void
}

export default function UnvoteModal({ projectTitle, onConfirm, onCancel }: UnvoteModalProps) {
  ...
  return createPortal(
    ...
    >
      ...
      >
        <div className="p-6">
          <h2 className="text-lg font-bold text-white mb-1">Remove your vote?</h2>
          <p className="text-sm text-white/40 mb-6 truncate">{projectTitle}</p>
